...
FetchContent_Declare(
        gRPC
        GIT_REPOSITORY https://github.com/rprichard/grpc/
        GIT_TAG 00b89a2ff45228e35cdc0f286d253ccbcc21763e
)
set(FETCHCONTENT_QUIET OFF)
set(gRPC_BUILD_TESTS OFF)
set(gRPC_BUILD_CODEGEN ON) # for grpc_cpp_plugin
set(gRPC_BUILD_GRPC_CPP_PLUGIN ON) # we want to use only C++ plugin
set(gRPC_BUILD_GRPC_PYTHON_PLUGIN ON)
...
function(target_add_protobuf target)
    MESSAGE("Generating CPP protobufs")
    ...
    foreach(FIL ${ARGN})
        ...
        file(RELATIVE_PATH REL_FIL ${ROOT_DIR} ${ABS_FIL})
        ...
        MESSAGE(STATUS "Generating ${RELFIL_WE}.grpc.pb.cc and ${RELFIL_WE}.grpc.pb.h")
        add_custom_command(
